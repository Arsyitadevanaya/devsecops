...
| `docker compose ps` | ![alt text](img/image-22.png) | `PASS` |
| `curl -v http://localhost:8080` (API health) | ![alt text](img/image-24.png) | `PASS` |
| `docker compose logs --tail 100` | ![alt text](img/image-25.png) | `PASS` |
